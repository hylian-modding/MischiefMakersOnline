...
class Actor {
    ...
    get pos_0() {
        ...
        return new Vector3_1.default(this.emulator.rdramReadS16(addr), this.emulator.rdramReadS16(addr + 4), this.emulator.rdramReadS32(addr + 8));
    }
    get pos_1() {
    ...
    get current_sprite() {
        return this.emulator.rdramRead8(exports.ACTOR_LIST_POINTER + (this.index * exports.SIZEOF_ACTOR) + exports.ACTORO_SPRITE);
    }
    get current_sprite_index() {
        return this.emulator.rdramRead8(exports.ACTOR_LIST_POINTER + (this.index * exports.SIZEOF_ACTOR) + exports.ACTORO_SPRITE + 1);
    }
    get pos_2() {
        let addr = exports.ACTOR_LIST_POINTER + (this.index * exports.SIZEOF_ACTOR) + exports.ACTORO_POS2;
        return new Vector3_1.default(this.emulator.rdramReadS16(addr), this.emulator.rdramReadS16(addr + 4), this.emulator.rdramReadS16(addr + 8));
    }
    get render_flags() {
    ...
    get pos_3() {
        ...
        return new Vector2_1.default(this.emulator.rdramReadS16(addr), this.emulator.rdramReadS16(addr + 2));
    }
    get pos_4() {
    ...
    get velocity() {
        ...
        return new Vector2_1.default(this.emulator.rdramReadS16(addr), this.emulator.rdramReadS16(addr + 4));
    ...
    set current_sprite(value) {
        this.emulator.rdramWrite8(exports.ACTOR_LIST_POINTER + (this.index * exports.SIZEOF_ACTOR) + 0x84, value);
    }
    set current_sprite_index(value) {
        this.emulator.rdramWrite8(exports.ACTOR_LIST_POINTER + (this.index * exports.SIZEOF_ACTOR) + 0x85, value);
    }
    set pos_2(value) {
...
class Player extends Actor {
    ...
    get camera_pos_final() {
        let addr = exports.GLOBAL_CONTEXT_POINTER + 0x90;
        return new Vector2_1.default(this.emulator.rdramReadS16(addr), this.emulator.rdramReadS16(addr + 4));
    }
    get real_pos() {
